                        ...
                        <div className="mb-4">
                            ...
                            <div className="w-full">
                                <input
                                    ...
                                    className="w-full px-4 py-2.5 bg-gray-50 border-2 border-gray-200 rounded-xl text-gray-800 focus:outline-none focus:border-blue-500 transition-all text-sm"
                                    required
                                />
                            </div>
